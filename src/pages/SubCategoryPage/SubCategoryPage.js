...
const SubCategoryPage = () => {
    ...
    const handleFetch = async () => {
        try {
            const res = await axios.get("https://api.prestigeindustries.co.in/api/subcategory");
    ...
    const hadndleDelete = async (_id) => {
        try {
            const res = await axios.delete(`https://api.prestigeindustries.co.in/api/subcategory/${_id}`);
