...
const EditCategory = () => {
  ...
  const handleFetch = async () => {
    try {
      const res = await axios.get("https://api.prestigeindustries.co.in/api/category/" + _id);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const submitResponse = await axios.put("https://api.prestigeindustries.co.in/api/category/" + _id, formData);
